    ...
    <div id="qualifications">
      ...
      <div className="qualifications-container">
        <div className="qualification">
          <div className="content html"> <div class="skills__bar skills__html"> </div> </div>
          <div>
            <br></br>
        ...
        <div className="qualification">
          <div className="content css"> <div class="skills__bar skills__css"> </div> </div>
          <div>
            <br></br>
        ...
        <div className="qualification">
          <div className="content javascript"> <div class="skills__bar skills__javascript"> </div> </div>
          <div>
            <br></br>
        ...
        <div className="qualification">
          <div className="content bootstrap"> <div class="skills__bar skills__bootstrap"> </div> </div>
          <div>
            <br></br>
            <span class="skills__percentage">80%</span>
          </div>
        ...
        <div className="qualification">
          <div className="content react"> <div class="skills__bar skills__react"> </div> </div>
          <div>
            <br></br>
